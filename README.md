...
│   └── diff_dirs_b2000.txt   		  # Acquisition protocol
│
├── data/
│   └── multi_compartment_dataset.csv # Examples for generated datasets
│
├── training/
...
│
├── models/					  		  # Output folder for models/logs
│
...
Training, validation and test data are automatically generated by the datagen script.
They are stored as .csv files in the format expected by Train_Utils.get_data():
...
python3 training/main.py \
    --model_folder default_run \
    --train_data_file data_train.csv \
    --val_data_file data_val.csv \
    --test_data_file data_test.csv
```
